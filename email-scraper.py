...
class EmailScraper():
    ...
    def run(self):
        ...
        if args.company and args.email:
            ...
            print("\nTry again... Maybe run with '-ha' Hunter.io first and then use '-e' and the email format")
...
1) Fix the email scraping around Google
2) Am I getting all the emails from Hunter.io
3) Any more email sources? 
